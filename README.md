...
<p align="center">
  <strong>Интерактивный 3D-симулятор разборки и сборки насоса</strong>
</p>
...
**Pump Disassembly Simulator** — это учебный 3D-симулятор от первого лица, предназначенный для обучения правильной последовательности разборки и сборки промышленного насоса. Проект разработан для использования в образовательных целях, позволяя студентам и специалистам отрабатывать навыки обслуживания оборудования в безопасной виртуальной среде.
...
- **Три режима работы:**
  ...
  - 🏋️ **Тренировка** — ограниченная помощь, свобода действий
  - 📝 **Экзамен** — минимальные подсказки, строгая оценка
- **Система инвентаря** — хотбар с 5 слотами, drag-and-drop, 20 слотов инвентаря
- **JSON-сценарии** — гибкая настройка последовательностей шагов через JSON
- **Логирование сессий** — полный протокол действий с оценкой по 5-балльной системе
- **Экспорт отчётов** — сохранение в HTML и печать
- **Динамическая камера** — head-bobbing, sway, приседание с учётом веса предмета

## 🖥️ Скриншоты

*(Добавьте скриншоты вашего проекта здесь)*
...
**det-mey** — [GitHub Profile](https://github.com/det-mey)

---

<p align="center">
  <em>Сделано с ❤️ на Godot Engine</em>
</p>
